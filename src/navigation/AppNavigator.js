          ...
          if (focused && route.name === "Home") {
            return (
              <View style={{
                ...
                borderWidth: 0.7, borderColor: "rgba(22,131,255,0.22)",
                justifyContent: "center", alignItems: "center",
                shadowColor: "#1683FF", shadowOpacity: 0.03,
                shadowRadius: 3, shadowOffset: { width: 0, height: 4 },
              }}>
                <Ionicons name="home" size={19} color="#1683FF" />
              </View>
            );
          }
